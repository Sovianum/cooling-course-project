...
\begin{center}
	\begin{tabular}{|p{7cm}|c|c|c|}
		...
		Расход газа & $G_г$ & кг/c & <-<.Gas.GasMassRate | Round1>-> \\ \hline
		Длина лопатки & $l$ & м & <-<.Geom.BladeLength | MultiplyE3 | Round1>-> \cdot 10^{-3} \\ \hline
		Средний диаметр & $D_{ср}$ & м & <-<.Geom.DMean | MultiplyE3 | Round1>-> \cdot 10^{-3} \\ \hline
		...
		Диаметр входной кромки & $d_{вх.кр.}$ & $м$ & <-<.Geom.DInlet | MultiplyE3 | Round1>-> \cdot 10^{-3} \\ \hline
 	...
 	Результаты расчета сведены в таблицу:
		\begin{center}
			\begin{tabular}{|p|c|c|c|}
				...
				<-<range .Gas.TableRows>->
					<-<.Id>-> & <-<.AirMassRate | Round1>-> & <-<.DCoef | MultiplyE3 | Round3>-> \cdot 10^{-3} & <-<.EpsCoef | Round2>-> & <-<.AirGap | MultiplyE3 | Round1>-> \cdot 10^-3 \\\hline
				<-<end>->
			\end{tabular}
		\end{center}
